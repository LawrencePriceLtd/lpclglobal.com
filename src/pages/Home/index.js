        ...
        <div className="md:px-16 px-5 md:py-20 py-20">
          ...
          <div className="md:flex items-baseline md:pt-0 pt-12 md:h-400px">
            ...
            <div className="bg-altgrey relative h-full w-full">
              <Link to="/blog" type="button" className="dark:bg-orange w-full absolute bottom-0 flex items-center space-x-6 text-lg font-medium md:pl-20 pl-10 pr-10 text-coregray  dark:text-white pb-6 md:pt-36 pt-6 flex-grow-0">
        ...
        <div className="md:flex items-center md:pl-16 md:pr-0 pr-5 md:space-y-0 space-y-20 px-5 md:py-32 py-20">
          ...
          <div className="md:w-1/2">
            <div className="w-full">
              <svg className="md:block hidden" width="976" height="614" viewBox="0 0 976 614" fill="none" xmlns="http://www.w3.org/2000/svg">
