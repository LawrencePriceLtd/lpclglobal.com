...
const Home = () => {
  ...
  return (
    <div className="">
      ...
      <section className="bg-altgrey dark:bg-kiwi">
        <div className="md:flex items-center md:pl-16 md:space-y-0 space-y-20 px-5 md:py-32 py-20">
          <div className="md:w-1/2">
            <AttentionSeeker>
          ...
          <div className="md:w-1/2">
            <div>
              <svg width="976" height="614" viewBox="0 0 976 614" fill="none" xmlns="http://www.w3.org/2000/svg">
