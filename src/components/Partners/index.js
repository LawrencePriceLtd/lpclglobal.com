...
const Partners = () => (
  <div className="md:px-16 md:py-40">
    <h1 className="text-4rem font-medium font-trirong dark:text-white">Our Partners</h1>
    <h1 className="text-5xl text-coregray pt-10 font-medium dark:text-gray-300">We Trusted By and in partnership with</h1>
